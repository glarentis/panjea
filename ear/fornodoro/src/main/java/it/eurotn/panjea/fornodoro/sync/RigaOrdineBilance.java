...
public class RigaOrdineBilance {
     ...
     */
    public RigaOrdineBilance(final RigaDistintaCarico rigaDistintaCarico, final Articolo articolo, String um) {
        ...
        codiceTipoDoc = areaOrdine.getTipoAreaOrdine().getTipoDocumento().getCodice();

        this.um = um;

        numeroriga = new Double(rigaDistintaCarico.getRigaArticolo().getOrdinamento() / 1000).intValue();
        ...
        dataInizioTrasporto = rigaDistintaCarico.getDataInizioTrasporto();
