...
public class GetNomeFileZipFatturaPA  implements java.io.Serializable {
    private java.lang.String codiceCliente;

    private byte[] passwordServizi;

    public GetNomeFileZipFatturaPA() {
    }
    ...
    /**
     * Gets the codiceCliente value for this GetNomeFileZipFatturaPA.
     * 
    ...
    /**
     * Sets the codiceCliente value for this GetNomeFileZipFatturaPA.
     * 
     * @param codiceCliente
     */
    ...
    /**
     * Gets the passwordServizi value for this GetNomeFileZipFatturaPA.
     * 
    ...
    /**
     * Sets the passwordServizi value for this GetNomeFileZipFatturaPA.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetNomeFileZipFatturaPA)) return false;
        GetNomeFileZipFatturaPA other = (GetNomeFileZipFatturaPA) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetNomeFileZipFatturaPA.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetNomeFileZipFatturaPA"));
