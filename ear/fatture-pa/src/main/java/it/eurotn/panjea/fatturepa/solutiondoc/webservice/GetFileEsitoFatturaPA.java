...
public class GetFileEsitoFatturaPA  implements java.io.Serializable {
    private java.lang.String codiceCliente;

    private byte[] passwordServizi;

    private java.lang.String idEsito;

    public GetFileEsitoFatturaPA() {
    }

    public GetFileEsitoFatturaPA(
           java.lang.String codiceCliente,
           byte[] passwordServizi,
           java.lang.String idEsito) {
    ...
    /**
     * Gets the codiceCliente value for this GetFileEsitoFatturaPA.
     * 
    ...
    /**
     * Sets the codiceCliente value for this GetFileEsitoFatturaPA.
     * 
     * @param codiceCliente
     */
    ...
    /**
     * Gets the passwordServizi value for this GetFileEsitoFatturaPA.
     * 
    ...
    /**
     * Sets the passwordServizi value for this GetFileEsitoFatturaPA.
     * 
    ...
    /**
     * Gets the idEsito value for this GetFileEsitoFatturaPA.
     * 
     * @return idEsito
     */
    ...
    /**
     * Sets the idEsito value for this GetFileEsitoFatturaPA.
     * 
     * @param idEsito
     */
    public void setIdEsito(java.lang.String idEsito) {
        this.idEsito = idEsito;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFileEsitoFatturaPA)) return false;
        GetFileEsitoFatturaPA other = (GetFileEsitoFatturaPA) obj;
        ...
        _equals = true && 
            ...
            ((this.idEsito==null && other.getIdEsito()==null) || 
             (this.idEsito!=null &&
              this.idEsito.equals(other.getIdEsito())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFileEsitoFatturaPA.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetFileEsitoFatturaPA"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "idEsito"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
