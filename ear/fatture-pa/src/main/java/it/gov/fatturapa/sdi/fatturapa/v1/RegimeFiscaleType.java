...
/**
 * <p>
 * Java class for RegimeFiscaleType.
 *
 * <p>
...
public enum RegimeFiscaleType {
	...
	/**
	 * IVA per cassa soggetti con volume d’affari inferiore ad euro 200.000 (art. 7, D.L. 185/2008)
	 *
	 */
	@XmlEnumValue("RF17")
	RF_17("RF17"),
	 ...
	 * @param v
	 *            valore
	 * @return {@link RegimeFiscaleType} corrispondente
	 */
	public static RegimeFiscaleType fromValue(String v) {
		...
		throw new IllegalArgumentException("Regime fiscale " + v
				+ " non previsto per il formato di trasmissione selezionato ");
	}
	 ...
	 *            valore
	 */
	RegimeFiscaleType(final String v) {
		value = v;
	}
