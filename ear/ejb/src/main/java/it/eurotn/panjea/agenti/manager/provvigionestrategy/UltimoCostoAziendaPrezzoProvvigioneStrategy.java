 ...
 *
 */
@Stateless(name = "Panjea.UltimoCostoAziendaPrezzoProvvigioneStrategy")
@SecurityDomain("PanjeaLoginModule")
@PermitAll
@LocalBinding(jndiBinding = "Panjea.UltimoCostoAziendaPrezzoProvvigioneStrategy")
public class UltimoCostoAziendaPrezzoProvvigioneStrategy implements CalcoloPrezzoProvvigioneStrategy {

    private static final Logger LOGGER = Logger.getLogger(UltimoCostoAziendaPrezzoProvvigioneStrategy.class);
