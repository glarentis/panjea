...
public class ContoRigaContabileBuilder extends AbstractRigaContabileBuilder {
	 ...
	 *            {@link AziendeManager}
	 */
	public ContoRigaContabileBuilder(final PianoContiManager pianoContiManager, final FormuleManager formuleManager,
	...
	public SottoConto getSottoConto(AreaContabile areaContabile, String codiceTipologiaConto)
		...
		return pianoContiManager.caricaSottoConto(codiceTipologiaConto);
	}
