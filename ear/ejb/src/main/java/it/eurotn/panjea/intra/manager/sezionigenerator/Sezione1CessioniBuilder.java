...
public class Sezione1CessioniBuilder extends SezioneRigheBuilder<RigaSezione1Intra> {

	private static Logger logger = Logger.getLogger(Sezione1CessioniBuilder.class);

	/**
	 * Costruttore.
	 */
	public Sezione1CessioniBuilder() {
		super();
	}
