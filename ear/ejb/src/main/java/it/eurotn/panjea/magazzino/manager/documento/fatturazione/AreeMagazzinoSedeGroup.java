...
public class AreeMagazzinoSedeGroup extends ArrayList<List<AreaMagazzinoFatturazione>> {
	 ...
	 */
	public AreeMagazzinoSedeGroup(final Collection<AreaMagazzinoFatturazione> areeMagazzino) {
		...
		Comparator<AreaMagazzinoFatturazione> comparator = new Comparator<AreaMagazzinoFatturazione>() {
			...
			public int compare(AreaMagazzinoFatturazione o1, AreaMagazzinoFatturazione o2) {
				return o1.getSedeEntita().compareTo(o2.getSedeEntita());
			}
		};
