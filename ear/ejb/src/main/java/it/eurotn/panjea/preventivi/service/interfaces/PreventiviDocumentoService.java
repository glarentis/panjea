package it.eurotn.panjea.preventivi.service.interfaces;
...
@Remote
public interface PreventiviDocumentoService {
	 ...
	 *
	 * @param areePreventivo
	 *            aree da cancellare
	 */
	void cancellaAreePreventivo(List<AreaPreventivo> areePreventivo);
	 ...
	 */
	AreaPreventivoFullDTOStampa caricaAreaPreventivoFullDTOStampa(Map<Object, Object> paramenters);
	 ...
	 *
	 * @param areaPreventivo
	 *            area preventivo di riferimento
	 * @param note
	 *            note
	 ...
	 *
	 * @param areaPreventivo
	 *            area preventivo * @param areaRate areaRate
	 * @param cambioStato
