...
public class Sezione4CessioniBuilder extends SezioneRigheBuilder<RigaSezione4Intra> {

	private static Logger logger = Logger.getLogger(Sezione4CessioniBuilder.class);
