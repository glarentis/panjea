...
public class Sezione3CessioniBuilder extends SezioneRigheBuilder<RigaSezione3Intra> {

	private static Logger logger = Logger.getLogger(Sezione3CessioniBuilder.class);
