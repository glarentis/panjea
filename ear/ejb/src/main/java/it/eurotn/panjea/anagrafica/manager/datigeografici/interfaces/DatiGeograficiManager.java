package it.eurotn.panjea.anagrafica.manager.datigeografici.interfaces;
...
@Local
public interface DatiGeograficiManager {
    ...
    /**
     * Cerca di caricare i dati geografici contenuti in datiGeografici (impostando solamente il
     * codice per i vari livelli)<br/>
     * Se non li trova li crea
     * 
     * @param datiGeografici
     *            datiGeografici da caricare
     * @return datigeografici trovati o creati.
     */
    DatiGeografici caricaeCreaDatiGeografici(DatiGeografici datiGeografici);
     ...
     */
    List<LivelloAmministrativo1> caricaLivelloAmministrativo1(DatiGeografici datiGeografici, String filtro);

    /**
     * Carica la lista di livelloAmministrativo2 per i datiGeografici correnti. <br>
     * Il livello 2 è più dettagliato rispetto al livello 1 (nel caso dell'italia equivale alle
     * province).
     *
     * @param filtro
     *            valore da filtrare
     ...
     */
    List<LivelloAmministrativo2> caricaLivelloAmministrativo2(DatiGeografici datiGeografici, String filtro);

    /**
     * Carica la lista di livelloAmministrativo3 per i datiGeografici correnti. <br>
     * Il livello 3 è più dettagliato rispetto al livello 2 (nel caso dell'italia equivale ai
     * comuni).
     *
     * @param filtro
     *            valore da filtrare
     ...
     */
    List<LivelloAmministrativo3> caricaLivelloAmministrativo3(DatiGeografici datiGeografici, String filtro);
     ...
     */
    List<LivelloAmministrativo4> caricaLivelloAmministrativo4(DatiGeografici datiGeografici, String filtro);
    ...
    /**
     * Carica la lista di {@link SuddivisioneAmministrativa} scelta via
     * {@link NumeroLivelloAmministrativo}.
     *
     * @param datiGeografici
    ...
    /**
     * Ricerca cap per descrizione
     * 
     * @param descrizioneCap
     *            decrizione da cercare
     * @return lista di cap corrisondenti. I vari cap possono avere località diverse collegate.
     */
    List<Cap> ricercaCap(String descrizioneCap);
