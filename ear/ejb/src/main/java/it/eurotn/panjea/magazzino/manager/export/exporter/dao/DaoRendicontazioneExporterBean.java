...
@Stateless(name = "Panjea.RendicontazioneExporter.Dao")
@SecurityDomain("PanjeaLoginModule")
@PermitAll
@LocalBinding(jndiBinding = "Panjea.RendicontazioneExporter.Dao")
public class DaoRendicontazioneExporterBean implements RendicontazioneExporter {

	private static Logger logger = Logger.getLogger(DaoRendicontazioneExporterBean.class);
			...
			try {
				...
				for (RigaMagazzino rigaMagazzino : areaMagazzinoLoad.getRigheMagazzino()) {
					...
					if (idAreaMagazzino != rigaMagazzino.getAreaMagazzino().getId()
						...
						rendicontazioneBeans.add(new DaoAreaRendicontazioneBeanExporter(tipoEsportazione
					...
					if (rigaMagazzino instanceof RigaArticolo) {
						...
						rendicontazioneBeans.add(new DaoRigaRendicontazioneBeanExporter((RigaArticolo) rigaMagazzino,
