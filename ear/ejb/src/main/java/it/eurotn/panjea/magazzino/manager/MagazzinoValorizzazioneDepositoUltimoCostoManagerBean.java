...
@Stateless(name = "Panjea.MagazzinoValorizzazioneDepositoUltimoCostoManager")
@SecurityDomain("PanjeaLoginModule")
@PermitAll
@LocalBinding(jndiBinding = "Panjea.MagazzinoValorizzazioneDepositoUltimoCostoManager")
public class MagazzinoValorizzazioneDepositoUltimoCostoManagerBean extends MagazzinoValorizzazioneDepositoManagerBean
	...
	protected String getCostoFinale(ParametriRicercaValorizzazione parametri) {
		...
		sb.append(" am.depositoOrigine_id = :deposito_id and ");
		sb.append(" rm.articolo_id = idArticolo ");
		sb.append("order by am.dataRegistrazione desc limit 1),0) as costo,");
		return sb.toString();
	}
}
