...
@Local
public interface CalendariRateManager {
	...
	/**
	 * Carica il calendario aziendale per la categoria rata specificata.
	 * 
	 * @param categoriaRata
	 *            categoria rata
	 * @return calendario caricato, <code>null</code> se non esiste
	 */
	CalendarioRate caricaCalendarioRateAziendale(CategoriaRata categoriaRata);

	/**
	 * Carica il calendario del cliente e categoria rata specificata.
	 * 
	 * @param clienteLite
	 *            cliente
	 * @param categoriaRata
	 ...
	 * @return calendario caricato, <code>null</code> se non esiste
	 */
	CalendarioRate caricaCalendarioRateCliente(ClienteLite clienteLite, CategoriaRata categoriaRata);
