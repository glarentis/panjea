 ...
 *
 */
public class RiepilogoSediEntitaPerVettoreQueryBuilder extends RiepilogoSediEntitaFactoryQueryBuilder {

	private Integer idVettore = null;

	/**
	 * Costruttore.
	 *
	 * @param idVettore
	 *            id del vettore per cui restringere la ricerca
	 */
	public RiepilogoSediEntitaPerVettoreQueryBuilder(final Integer idVettore) {
	...
	protected String getHqlLeftJoins() {
		...
		sb.append(" left join se.vettore vettore ");
		return sb.toString();
	}

	@Override
	protected String getHqlOptionalWhere() {
		return " and (vettore.id=" + idVettore + ") ";
	}
