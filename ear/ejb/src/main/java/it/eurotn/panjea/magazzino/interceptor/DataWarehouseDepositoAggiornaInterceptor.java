 ...
 */
public class DataWarehouseDepositoAggiornaInterceptor {

	private static Logger logger = Logger.getLogger(DataWarehouseDepositoAggiornaInterceptor.class);
	 ...
	 */
	@AroundInvoke
	public Object aggiornaDeposito(InvocationContext ctx) throws Exception {
		...
		query.setParameter(DataWarehouseDepositiSqlBuilder.PARAM_FILTRO_DEPOSITO_ID, ((Deposito) result).getId());
		try {
