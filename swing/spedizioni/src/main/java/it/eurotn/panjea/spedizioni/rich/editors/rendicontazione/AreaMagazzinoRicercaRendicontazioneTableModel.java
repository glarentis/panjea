...
public class AreaMagazzinoRicercaRendicontazioneTableModel extends DefaultBeanTableModel<AreaMagazzinoRicerca> {
	 ...
	 * Costruttore.
	 */
	public AreaMagazzinoRicercaRendicontazioneTableModel() {
		super(RisultatiRicercaAreaMagazzinoRendicontazioneTablePage.PAGE_ID, new String[] { "documento.codice",
