...
public interface IDatiGeograficiBD {
	...
	/**
	 * Carica il cap con l'id selezionato.
	 * 
	 * @param idCap
	...
	List<SuddivisioneAmministrativa> caricaSuddivisioniAmministrative(DatiGeografici datiGeografici,
			SuddivisioneAmministrativa.NumeroLivelloAmministrativo lvl, String valueSearch);
