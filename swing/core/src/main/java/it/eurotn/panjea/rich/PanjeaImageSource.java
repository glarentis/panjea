 ...
 * <p>
 * This class by default performs caching of all loaded image resources using soft references (TODO it just lazy loads
 * them, but it doesn't use SoftReference).
 *
 * <p>
 * An image {@link Handler} is available that handles the 'image' protocol. Check the javadocs of the handler to know
 * how to use/register it.
 * </p>
 *
 * @author Keith Donald
 */
public class PanjeaImageSource implements ImageSource {
    ...
    protected static final Log logger = LogFactory.getLog(PanjeaImageSource.class);
     ...
     */
    public PanjeaImageSource(boolean installUrlHandler, Map imageResources) {
     ...
     * Creates a image resource bundle containing the specified map of keys to resource paths.
     * <p>
     * A custom URL protocol {@link Handler handler}will be installed for the "image:" protocol. This allows for images
     * in this image source to be located using the Java URL classes: <br>
     * <code>URL imageUrl = new URL("image:the.image.key")</code>
     *
     * @param imageResources
     *            a map of key-to-image-resources.
     */
    public PanjeaImageSource(Map imageResources) {
