...
public class DropShadowCollapsiblePane extends CollapsiblePane implements PropertyChangeListener {

    private static final long serialVersionUID = 1998565553095782642L;
     ...
     * </p>
     */
    public DropShadowCollapsiblePane() {
     ...
     * </p>
     */
    public DropShadowCollapsiblePane(final LayoutManager layout) {
     ...
     * </p>
     */
    public DropShadowCollapsiblePane(final ShadowRenderer factory, final LayoutManager layout) {
        super();
        setLayout(layout);
