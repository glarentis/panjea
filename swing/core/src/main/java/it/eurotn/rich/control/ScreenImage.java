...
public class ScreenImage {
    ...
    /**
     * Create a BufferedImage from a rectangular region on the screen. This will include Swing components JFrame,
     * JDialog and JWindow which all extend from Component, not JComponent.
     * 
     * @param region
