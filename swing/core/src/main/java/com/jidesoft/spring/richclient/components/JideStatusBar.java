...
/**
 * Implementation of the Spring RCP StatusBar concept using the JIDE status bar as the underlying component. By default
 * the status bar includes a component for displaying messages, using LabelStatusBarItem, and a progress monitor, using
 * ProgressStatusBarItem. Extra status bar items can be added to the bar via the statusBarItems parameter.
 * 
 * @author Jonny Wray
 * 
 */
public class JideStatusBar implements StatusBar {
	...
	/**
	 * Can be overridden to provide another progress status bar item. For example, replacing the cancel button by an
	 * icon.
	 */
	...
	/**
	 * Controls whether to enable the cancel button on the progress monitor. Default is true.
	 * 
	 */
	@Override
	...
	/**
	 * Configure the call-back to be used when the cancel button is pressed. If not configured a default is use that
	 * sets the cancel flag on the progress monitor.
	 * 
