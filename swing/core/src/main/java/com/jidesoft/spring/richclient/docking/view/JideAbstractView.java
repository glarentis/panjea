...
/**
 * An extension of the Spring RCP abstract view to implement the ability to specify view specific toolbars and menu bar.
 * 
 * @author Jonny Wray
 * 
 */
public abstract class JideAbstractView extends AbstractView {
	...
	public CommandGroup getCommandGroup(String name) {
		JideApplicationLifecycleAdvisor advisor = ((JideApplicationLifecycleAdvisor) getApplication()
				.getLifecycleAdvisor());
