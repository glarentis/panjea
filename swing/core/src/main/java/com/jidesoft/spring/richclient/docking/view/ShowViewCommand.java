...
/**
 * Slight modification of the Spring RCP ShowViewCommand to use the viewDescriptor.getId as the id for the show view
 * command, as opposed to the viewDescriptor.getDisplayName. Integrates better with command labels and icons then.
 * 
 * @author Jonny Wray
 * 
 */
