...
/**
 * Extension of the ProgressStatusBarItem that uses an icon instead of the default textual button for cancel. Uses
 * 'statusbar.cancel' to obtain the Icon and 'statusbar.tooltip.cancel' to get the tooltip for the cancel button.
 * 
 * @author Jonny Wray
 * 
 */
public class IconProgressStatusBarItem extends ProgressStatusBarItem {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7903182961727956297L;
	...
	public AbstractButton createCancelButton() {
		...
		AbstractAction action = new AbstractAction(null, iconSource.getIcon(CANCEL_ICON)) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1307563353300562552L;
