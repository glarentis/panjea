...
/**
 * Extends the default view descriptor to add the ability to compare the view descriptors, and thus produce alphabetical
 * lists, and support for the generation of a show view command. The ability to specify dockingframe init parameters is
 * also handled.
 * 
 * @author Jonny Wray
 * 
