...
/**
 * Slight change to the Spring RCP show view menu to check if the view is not a workspace view before adding it to menu.
 * 
 * @author Jonny Wray
 * 
 */
public class ShowViewMenu extends CommandGroup implements ApplicationWindowAware {
	...
	@Override
	public void setApplicationWindow(ApplicationWindow paramWindow) {
