...
public class JideApplicationLifecycleAdvisor extends DefaultApplicationLifecycleAdvisor {
	...
	/**
	 * Allows the injection of a global repaint manager, although not required, in which case default is used.
	 * 
	 * Initial motivation came from the discussion in <a href="http://www.sourcebeat.com/TitleAction.do?id=10">Desktop
	 * Java Live</a> by Scott Deplay about using a custom repaint manager to check for illegal UI updates outside of the
	 * EDT.
	 * 
	 * 
	...
	/**
	 * Change the default StatusBarCommandGroup by providing another implementation.
	 * 
	 * @param statusBar
	 */
	...
	/**
	 * Returns the current status bar. If one is not injected in the configuration file the default is used.
	 */
	@Override
