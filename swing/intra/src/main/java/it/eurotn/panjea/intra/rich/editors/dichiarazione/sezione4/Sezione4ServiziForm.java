...
public class Sezione4ServiziForm extends PanjeaAbstractForm {

	private static final String FORM_ID = "sezione4ServiziForm";
	 ...
	 * Costruttore.
	 * 
	 * @param rigaSezione4Intra
	 *            per init
	 */
	public Sezione4ServiziForm(final RigaSezione4Intra rigaSezione4Intra) {
		super(PanjeaFormModelHelper.createFormModel(rigaSezione4Intra, false, FORM_ID), FORM_ID);
	...
	protected JComponent createFormControl() {
		...
		// "progressivo", "sezioneDoganale", "anno", "protocolloDic",
		// "progrSezione3", "fornitoreStato", "fornitorepiva", "importo",
		...
		JTextField sezDoganale = (JTextField) builder.addPropertyAndLabel("sezioneDoganale", 1)[1];
		sezDoganale.setColumns(14);
		JTextField anno = (JTextField) builder.addPropertyAndLabel("anno", 5)[1];
		anno.setColumns(14);
		builder.nextRow();

		JTextField protocolloDic = (JTextField) builder.addPropertyAndLabel("protocolloDic", 1)[1];
		protocolloDic.setColumns(14);
		JTextField progrSezione3 = (JTextField) builder.addPropertyAndLabel("progrSezione3", 5)[1];
		progrSezione3.setColumns(14);
		builder.nextRow();
		...
		SearchPanel searchPanelNomenclatura = (SearchPanel) builder.addBinding(bindingServizio, 3, 16, 5, 1);
	...
	protected Object createNewObject() {
		RigaSezioneIntra rigaSezioneIntra = new RigaSezione4Intra();
