...
public class ParametriImportazioneCarichi implements IDefProperty {
	 ...
	 * Costruttore.
	 */
	public ParametriImportazioneCarichi() {
		selezionato = false;
	}
	 ...
	 *            letturaFlussoAuVend
	 */
	public ParametriImportazioneCarichi(final LetturaFlussoAuVend letturaFlussoAuVend) {
		super();
