...
public class ImportazioneFatturazioneRifornimentiForm extends PanjeaAbstractForm {
	private class ImportaCommand extends ApplicationWindowAwareCommand {
		...
		protected void doExecuteCommand() {
			...
			ParametriRecuperoFatturazioneRifornimenti parametri = (ParametriRecuperoFatturazioneRifornimenti) getFormObject();
			try {
				...
				StatisticaImportazione result = auVendBD.verificaFatturazioneRifornimenti(parametri.getDataInizio(),
				...
				if (datiValidi) {
					auVendBD.importaFatturazioneRifornimenti(parametri.getDataInizio(), parametri.getDataFine());
					getFormModel().commit();
	 ...
	 * Costruttore.
	 */
	public ImportazioneFatturazioneRifornimentiForm() {
		super(PanjeaFormModelHelper.createFormModel(new ParametriRecuperoFatturazioneRifornimenti(), false, FORM_ID),
				FORM_ID);
