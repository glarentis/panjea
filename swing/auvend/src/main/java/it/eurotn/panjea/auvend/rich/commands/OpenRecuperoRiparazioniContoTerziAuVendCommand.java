 ...
 * 
 */
public class OpenRecuperoRiparazioniContoTerziAuVendCommand extends ApplicationWindowAwareCommand {

	private static final String COMMAND_ID = "openRecuperoRiparazioniContoTerziAuVendCommand";

	private Logger logger = Logger.getLogger(OpenRecuperoRiparazioniContoTerziAuVendCommand.class);
	 ...
	 * 
	 */
	public OpenRecuperoRiparazioniContoTerziAuVendCommand() {
		super(COMMAND_ID);
	}
	...
	protected void doExecuteCommand() {
		...
		ParametriRecuperoRiparazioniContoTerzi parametri = new ParametriRecuperoRiparazioniContoTerzi();
		dataUltimaLettura = auVendBD.caricaLetturaFlussoRiparazioniContoTerzi()
				.getUltimaLetturaFlussoRiparazioneContoTerzi();
