...
public interface IOrdiniDocumentoBD {

    /**
     * Aggiorna la data di consegna in accordo con la data di consegna dell'area ordine.<br>
     * Vengono modificate le righe con data di consegna uguale alla data di riferimento o tutte le
     ...
     *
     * @param idAreaOrdine
     *            id area Ordine da bloccare/sbloccare
     * @param blocca
     ...
     *
     * @param idOrdini
     *            id dell'area Ordini da bloccare/sbloccare
     * @param blocca
     *            true per bloccare l'area ordine, false per sbloccarla *
    ...
    /**
     *
     * @param ordiniDaCancellare
     *            numero degli ordini da cancellare.
     */
    @AsyncMethodInvocation
    void cancellaOrdiniImportati(Collection<String> ordiniDaCancellare);
    ...
    /**
     * Carica la movimentazione degli ordini per pagina .
     *
     ...
     *            provenienza prezzo dell'articolo
     * @param noteSuDestinazione
     *            indica se stampare le note riga sul documento di destinazione
     * @param codiceValuta
     ...
     *            tipologia del codice iva alternativo
     * @param percentualeScontoCommerciale
     *            percentuale sconto commerciale
     * @param gestioneArticoloDistinta
     *            indica se deve essere gestito l'articolo distinta
     * @return nuova rigaArticolo con i parametri settatti
     */
    @AsyncMethodInvocation
    RigaArticolo creaRigaArticolo(ProvenienzaPrezzo provenienzaPrezzo, Integer idArticolo, Date data,
     ...
     */
    void dividiRiga(Integer integer, List<RigaArticolo> righeDivise);
     ...
     */
    @AsyncMethodInvocation
    void evadiOrdini(List<RigaDistintaCarico> righeEvasione, Date dataEvasione)
    ...
    /**
     * Salva la riga ordine controllando lo stato dell'area Ordine e cambiandola se necessario.
     *
     * @param rigaOrdine
     ...
     *            Riga ordine da salvare
     * @param check
     *            true controlla la riga salvata e cambia lo stato dell'area ordine se necessario.
     * @return Riga ordine salvata
     */
    RigaOrdine salvaRigaOrdine(RigaOrdine rigaOrdine, boolean check);
    ...
    /**
     * salva la riga magazzino senza eseguire i controlli.
     *
     * @param righePerArea
     *            righe articolo da salvare
     */
