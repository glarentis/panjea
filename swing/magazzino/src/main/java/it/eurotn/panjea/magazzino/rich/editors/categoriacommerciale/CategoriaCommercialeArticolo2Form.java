...
public class CategoriaCommercialeArticolo2Form extends PanjeaAbstractForm {
	...
	private class CategoriaCommercialeChangeListener implements PropertyChangeListener {
		...
		public void propertyChange(PropertyChangeEvent evt) {
			...
			if (cat.getArticoli2() == null) {
				return;
			}
			for (ArticoloLite articoloLite : cat.getArticoli2()) {
	 ...
	 */
	public CategoriaCommercialeArticolo2Form(final FormModel formModel) {
