...
public class NoteRigaForm extends PanjeaAbstractForm {
	...
	private class ArticoloPropertyChangeListener implements PropertyChangeListener {
		...
		public void propertyChange(PropertyChangeEvent evt) {
			...
			String linguaSede = (rigaArticolo.getAreaMagazzino().getDocumento().getSedeEntita() != null) ? rigaArticolo
					.getAreaMagazzino().getDocumento().getSedeEntita().getLingua() : null;
	 ...
	 * 
	 * @param formModel
	 *            form model condiviso
	 */
	public NoteRigaForm(final FormModel formModel) {
