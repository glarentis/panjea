...
public class SottoSpecieForm extends PanjeaAbstractForm {
	private static final String FORM_ID = "sottoSpecieForm";
	 ...
	 *            sottoSpecie
	 */
	public SottoSpecieForm(final SottoSpecie sottoSpecie) {
		super(PanjeaFormModelHelper.createFormModel(sottoSpecie, false, FORM_ID), FORM_ID);
	...
	protected JComponent createFormControl() {
		...
		((JTextField) builder.addPropertyAndLabel(SottoSpecie.PROP_CODICE, 1)[1]).setColumns(4);
		builder.nextRow();

		builder.addPropertyAndLabel(SottoSpecie.PROP_DESCRIZIONE, 1);
		builder.nextRow();

		((JTextField) builder.addPropertyAndLabel(SottoSpecie.PROP_PERCENTUALE_AMMORTAMENTO, 1)[1]).setColumns(4);
		builder.nextRow();
