...
public class ParametriRicercaRilevazioneEvaDtsForm extends PanjeaAbstractForm {

    private static final String FORM_ID = "parametriRicercaRilevazioneEvaDtsForm";

    /**
     * Costruttore.
     */
    public ParametriRicercaRilevazioneEvaDtsForm() {
        super(PanjeaFormModelHelper.createFormModel(new ParametriRicercaRilevazioniEvaDts(), false, FORM_ID), FORM_ID);
