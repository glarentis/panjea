...
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.ApriAnalisiDashBoardCommand;
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.AssociazioneFiltriCommand;
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.CambiaVisualizzazioneCommand;
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.EsportaAnalisiCommand;
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.RicaricaAnalisiCommand;
import it.eurotn.panjea.bi.rich.editors.dashboard.widget.analisi.commands.ToggleFilterDescriptionCommand;
...
public class DashBoardAnalisiFrame extends DashBoardFrame {
    ...
    private final class ActivateFrameAdapter extends DockableFrameAdapter {
        ...
        public void dockableFrameRemoved(DockableFrameEvent paramDockableFrameEvent) {
            ...
            if (!(paramDockableFrameEvent.getDockableFrame()
                    .getClientProperty(DockingCompositeDialogPage.PAGE_PROPERTY_NAME) instanceof DashBoardPage)) {
                return;
            }

            DashBoardPage pageToRemove = (DashBoardPage) paramDockableFrameEvent.getDockableFrame()
                    .getClientProperty(DockingCompositeDialogPage.PAGE_PROPERTY_NAME);
