...
public class DashBoardPage extends AbstractDialogPage implements IPageLifecycleAdvisor, PropertyChangeListener {
     ...
     */
    protected DashBoardPage(final DashBoardAnalisi analisi, final IBusinessIntelligenceBD paramDatawarehouseBD)
            throws AnalisiNonPresenteException {
    ...
    public DashBoardPage(String frameKey) {
        super(frameKey);
        this.businessIntelligenceBD = null;
    }
    ...
    /**
     * Controllo UI per notificare il caricamento dei dati.
     */
    public void startAnalisi() {
        mainPanel.setOverlayVisible(true);
        progressPanel.setPreferredSize(getControl().getSize());
        progressPanel.setSize(getControl().getSize());
        progressPanel.start();
    }
