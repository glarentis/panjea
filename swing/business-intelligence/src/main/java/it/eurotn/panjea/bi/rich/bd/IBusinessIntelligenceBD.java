...
public interface IBusinessIntelligenceBD {
	 ...
	 */
	void cancellaAnalisi(int idAnalisiBI) throws AnalisiPresenteInDashBoardException;
	 ...
	 *            riferimento all'analisi da cancellare
	 * @throws AnalisiPresenteInDashBoardException
	 *             rilanciata se l'analisi è presente in qualche {@link DashBoard}
	 */
	 ...
	 */
	Map<String, byte[]> caricaFilesMappa(String nomeFileMappa);
