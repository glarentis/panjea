...
public interface IPartiteBD {
	 ...
	 */
	void cancellaCategoriaRata(Integer id);
	 ...
	 */
	void cancellaStrutturaPartita(Integer id);
	 ...
	 */
	CategoriaRata caricaCategoriaRata(Integer id);
	 ...
	 */
	List<ContoBase> caricaContiBase();
	 ...
	 */
	StrutturaPartita caricaStrutturaPartita(Integer id);
	 ...
	 */
	TipoDocumentoBasePartite caricaTipoDocumentoBase(TipoOperazione tipoOperazione);
	 ...
	 */
	List<RigaStrutturaPartite> creaRigheStrutturaPartite(StrutturaPartita strutturaPartita, int nRate, int intervallo);
	 ...
	 * @return TipoAreaPartita
	 */
	TipoAreaPartita salvaTipoAreaPartita(TipoAreaPartita tipoAreaPartita);
	 ...
	 */
	StrutturaPartita salveStrutturaPartita(StrutturaPartita strutturaPartita);
